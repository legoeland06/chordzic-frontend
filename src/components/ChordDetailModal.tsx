...
export default function ChordDetailModal({
  ...
  return (
    ...
    >
      <div
        className="bg-gray-900 rounded-xl border border-gray-700 p-6 w-96 shadow-2xl overflow-y-auto"
        ...
        <div className="grid grid-cols-2 gap-2 mb-4 text-sm">
          ...
          <div className="bg-gray-800/60 rounded-lg px-3 py-2">
            ...
            <div className="text-amber-400 font-bold font-mono">
              {chord.bass === chord.name ? '(fond.)' : chord.bass}
            </div>
          </div>
          <div className="bg-gray-800/60 rounded-lg px-3 py-2">
          ...
          <div className="flex flex-wrap gap-2">
            {chord.notes.map((note, ni) => {
              ...
              return (
                <div
                  key={ni}
                  title={`Intervalle: ${intervalName} (${interval} demi-tons)`}
                ...
                >
                  <span className="text-sm font-bold font-mono" style={{ color: getNoteColor(note) }}>
                    {note}
                  </span>
