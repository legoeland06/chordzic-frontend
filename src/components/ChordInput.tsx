  ...
  return (
    <div className="bg-gray-900 rounded-xl border border-gray-800 p-4 mb-4 relative">
      ...
      <label className="text-xs text-gray-500 mb-2 block font-mono">
        ...
        <span className="text-blue-400">Tab</span> pour compléter
      </label>
      ...
      {suggestions.length > 0 && suggestToken && (
        <div
          className="absolute left-4 z-50 mt-1 bg-gray-800 border border-gray-700 rounded-lg shadow-xl overflow-hidden"
