...
export default function ChordApp() {
  ...
  return (
    <div className="min-h-screen bg-gray-950 flex items-start justify-center px-4 sm:px-6 py-4">
      {/* Pleine largeur (option A — 21:37) : l'app occupe tout l'écran,
          les composants internes sont flex-wrap / pourcentages / fit scales */}
